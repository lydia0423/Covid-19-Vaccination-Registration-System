 ...
 * @author Eric
 */
public class PatientOptInMenu extends javax.swing.JFrame {

    /**
     * Creates new form PatientOptInMenu
     */
    public PatientOptInMenu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnManageVaccinationAppointment3.setText("Dependant Registration Details");
        ...
        btnManageVaccinationAppointment4.setText("Personal Registration Details");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientOptInMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientOptInMenu().setVisible(true);
            }
        });
    }
