 ...
 * @author Eric
 */
public class PatientViewPersonalDetails extends javax.swing.JFrame {

    /**
     * Creates new form PatientPersonalDetails
     */
    public PatientViewPersonalDetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnAddNewSupply3.setText("Update Details");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientViewPersonalDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientViewPersonalDetails().setVisible(true);
            }
        });
    }
